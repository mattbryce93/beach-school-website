  ...
  [4],
  {
    ...
    RXBc: function(A, o, B) {
      ...
      var Q = B('q1tI'),
        ...
        t = function(A) {
          return g.a.createElement(
            'header',
            { id: 'header', style: A.timeout ? { display: 'none' } : {} },
            g.a.createElement(
              'div',
              { className: 'logo' },
              g.a.createElement('span', { className: 'icon fa-diamond' })
            ),
            g.a.createElement(
              'div',
              { className: 'content' },
              g.a.createElement(
                'div',
                { className: 'inner' },
                g.a.createElement('h1', null, 'Dimension'),
                g.a.createElement(
                  'p',
                  null,
      ...
      var q = (function(A) {
          ...
          return (
            (B = A),
            ((o = Q).prototype = Object.create(B.prototype)),
              ...
              return g.a.createElement(
                ...
                g.a.createElement(
                  'article',
                  {
                    id: 'intro',
                    className:
                      ('intro' === this.props.article ? 'active' : '') +
                      ' ' +
                      (this.props.articleTimeout ? 'timeout' : ''),
                    style: { display: 'none' },
                  },
                  g.a.createElement('h2', { className: 'major' }, 'Intro'),
                  g.a.createElement(
                    'span',
                    { className: 'image main' },
                    g.a.createElement('img', { src: i.a, alt: '' })
                  ),
                  g.a.createElement(
                    'p',
                    null,
                    ...
                    g.a.createElement('a', { href: '#work' }, 'awesome work'),
                    '.'
                  ),
                  g.a.createElement(
                    'p',
                ...
                g.a.createElement(
                  'article',
                  {
                    id: 'work',
                    className:
                      ('work' === this.props.article ? 'active' : '') +
                      ' ' +
                      (this.props.articleTimeout ? 'timeout' : ''),
                    style: { display: 'none' },
                  },
                  g.a.createElement('h2', { className: 'major' }, 'Work'),
                  g.a.createElement(
                    'span',
                    { className: 'image main' },
                    g.a.createElement('img', { src: U.a, alt: '' })
                  ),
                  g.a.createElement(
                    'p',
                    null,
                ...
                g.a.createElement(
                  'article',
                  {
                    id: 'about',
                    className:
                      ('about' === this.props.article ? 'active' : '') +
                      ' ' +
                      (this.props.articleTimeout ? 'timeout' : ''),
                    style: { display: 'none' },
                  },
                  g.a.createElement('h2', { className: 'major' }, 'About'),
                  g.a.createElement(
                    'span',
                    { className: 'image main' },
                    g.a.createElement('img', { src: C.a, alt: '' })
                  ),
                  g.a.createElement(
                    'p',
                    null,
                ...
                g.a.createElement(
                  ...
                  g.a.createElement('h2', { className: 'major' }, 'Contact'),
                  g.a.createElement(
                    'form',
                    { method: 'post', action: '#' },
                    g.a.createElement(
                      ...
                      g.a.createElement('label', { htmlFor: 'name' }, 'Name'),
                    ...
                    g.a.createElement(
                      ...
                      g.a.createElement('label', { htmlFor: 'email' }, 'Email'),
                      g.a.createElement('input', {
                        type: 'text',
                        name: 'email',
                        id: 'email',
        ...
        R = function(A) {
          return g.a.createElement(
            'footer',
            { id: 'footer', style: A.timeout ? { display: 'none' } : {} },
            g.a.createElement(
              'p',
              { className: 'copyright' },
      ...
      var I = (function(A) {
        ...
        function Q(o) {
          ...
          return (
            ...
            (B.handleOpenArticle = B.handleOpenArticle.bind(D(B))),
            (B.handleCloseArticle = B.handleCloseArticle.bind(D(B))),
            (B.setWrapperRef = B.setWrapperRef.bind(D(B))),
            (B.handleClickOutside = B.handleClickOutside.bind(D(B))),
            B
          )
        }
        ;(B = A),
        ...
        return (
          ...
          (e.setWrapperRef = function(A) {
            this.wrapperRef = A
          }),
          (e.handleOpenArticle = function(A) {
            var o = this
            this.setState({
              ...
              setTimeout(function() {
                o.setState({ timeout: !o.state.timeout })
              }, 325),
              setTimeout(function() {
                o.setState({ articleTimeout: !o.state.articleTimeout })
              }, 350)
          }),
          (e.handleCloseArticle = function() {
            var A = this
            this.setState({ articleTimeout: !this.state.articleTimeout }),
              setTimeout(function() {
                A.setState({ timeout: !A.state.timeout })
              }, 325),
              setTimeout(function() {
                A.setState({
                  isArticleVisible: !A.state.isArticleVisible,
                  article: '',
                })
              }, 350)
          }),
          (e.handleClickOutside = function(A) {
            this.wrapperRef &&
              !this.wrapperRef.contains(A.target) &&
            ...
            return g.a.createElement(
              ...
              g.a.createElement(
                ...
                g.a.createElement(
                  ...
                  g.a.createElement(R, { timeout: this.state.timeout })
                ),
                g.a.createElement('div', { id: 'bg' })
              )
            )
          }),
          Q
    ...
    RYzB: function(A, o, B) {
      A.exports = B.p + 'static/pic01-55e1797fd15a7113b2be5a8fc1363d93.jpg'
    },
    pgDX: function(A, o) {
      A.exports =
...
//# sourceMappingURL=component---src-pages-index-js-ad753c32e9a2e13cf9c9.js.map
